...
const Razgildiay = () => {
  ...
  // Новый стейт для количества игроков
  ...
  // Добавьте функцию для выбора иконок игроков
    ...
    <div className="razgildiay-container">
      ...
      {!gameStarted ? (
        ...
        <div className="game-board">
          ...
          {/* Кнопки управления */}
          <div className="game-controls">
            {isDefending && currentPlayerIndex + 1 === 0 && (
              <button className="btn-take" onClick={handleTakeCards}>Взять</button>
            )}
            <button className="btn-back" onClick={handleBackToMenu}>Вернуться в меню</button>
          </div>
        </div>
